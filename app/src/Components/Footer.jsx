...
const Footer = ({isDisable,setIsDisable}) => {
  ...
  return (
    ...
    fixed bg-[#F6F8FAE5]/90  bottom-0 lg:w-[640px] border-t">
      <button onClick={saveDraftButton} disabled={isDisable} className={` ${isDisable ? 'cursor-not-allowed' : 'cursor-pointer custom-shadow-draft '}  flex items-center justify-center pt-[6px] pr-[16px] pb-[6px] pl-[14px] gap-[4px] border-1 rounded-[12px] bg-[#fff] `}>
       {
    ...
    <button onClick={publishedButton} disabled={isDisable} className={` ${isDisable ? 'cursor-not-allowed bg-[#219653] border-[#219653] opacity-50' : 'cursor-pointer bg-[#00AA45] border-[#1E874B] custom-shadow-publish'} flex items-center justify-center pt-[6px] pr-[16px] pb-[6px] pl-[14px] gap-[4px] border-1 rounded-[12px]  `}>
    <svg
  width={16}
  height={16}
  viewBox="0 0 16 16"
