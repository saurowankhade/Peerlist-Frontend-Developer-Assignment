  ...
  return (
    <div className="w-full items-center flex flex-col justify-center h-screen">
      <div className="lg:w-[640px] w-full flex flex-col border-[1px] relative h-full">
        ...
        {/* Body */}
        <div className="overflow-y-auto scroll-smooth scrollbar-hide mt-10 mb-12 h-fit">
          <div className='p-12'>
            {/* Form Inputs  */}
            <div className=''>
              form from 
            ...
            <div className='w-full flex flex-col justify-center items-center'>
...

              {
                ...
                <div className='w-full'>
                  <div className='h-[36px] rounded-[8px] gap-[16px] pt-2 pr-4 pb-2 pl-4 bg-[#FAFBFC] text-[#6A737D] font-[400] text-[12px] uppercase font-semibold'>Input Type</div>
                </div>
                {
                  inputType.map((inputData)=>(
                    <div className='
                     cursor-pointer h-[36px] flex items-center gap-2 rounded-[12px] p-2 hover:bg-[#FAFBFC]' key={inputData?.id}>
                      {inputData?.typeIcon()}
